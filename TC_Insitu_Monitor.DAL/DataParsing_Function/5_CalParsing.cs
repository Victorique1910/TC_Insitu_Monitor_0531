...
namespace TC_Insitu_Monitor.DAL
{
    ...
    { 
            ...
            foreach (var dataConfigsStatus in statuses.DataConfigsStatuses)
            {
                ...
                if (dataConfigsStatus.Configs.Type.Contains("Temperature"))
                {
                    if (!COMPort.Contains(dataConfigsStatus.Configs.COMPort))
                    {
                        ...
                        temperature = ComputeTemperature(temp.DataFormatStruct.LayerH, dataConfigsStatus.Configs.CompensationADCH, calConfigsStruct, point,3);
        ...
        /// <returns></returns>
        private double ComputeTemperature(double commendOut, double CompensationADCH, CalConfigsStruct calConfigsStruct, int point, int basePoint)
        {
            double[,] temp = new double[2, 19];
            bool isFirst = true;
            double min = double.MaxValue;
            double output = double.MaxValue;
            Console.WriteLine($"commendOut CompensationADCH {commendOut} {CompensationADCH}");
            temp[0, 0] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 9 * Math.Pow(10, basePoint - point)));
            temp[0, 1] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 8 * Math.Pow(10, basePoint - point)));
            temp[0, 2] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 7 * Math.Pow(10, basePoint - point)));
            temp[0, 3] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 6 * Math.Pow(10, basePoint - point)));
            temp[0, 4] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 5 * Math.Pow(10, basePoint - point)));
            temp[0, 5] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 4 * Math.Pow(10, basePoint - point)));
            temp[0, 6] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 3 * Math.Pow(10, basePoint - point)));
            temp[0, 7] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 2 * Math.Pow(10, basePoint - point)));
            temp[0, 8] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 1 * Math.Pow(10, basePoint - point)));
            temp[0, 9] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH - 0 * Math.Pow(10, basePoint - point)));
            temp[0, 10] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 1 * Math.Pow(10, basePoint - point)));
            temp[0, 11] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 2 * Math.Pow(10, basePoint - point)));
            temp[0, 12] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 3 * Math.Pow(10, basePoint - point)));
            temp[0, 13] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 4 * Math.Pow(10, basePoint - point)));
            temp[0, 14] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 5 * Math.Pow(10, basePoint - point)));
            temp[0, 15] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 6 * Math.Pow(10, basePoint - point)));
            temp[0, 16] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 7 * Math.Pow(10, basePoint - point)));
            temp[0, 17] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 8 * Math.Pow(10, basePoint - point)));
            temp[0, 18] = Math.Abs(calConfigsStruct.IdelTemperature - ReturnTempOutput(commendOut, commendOut, CompensationADCH + 9 * Math.Pow(10, basePoint - point)));
            temp[1, 0] = CompensationADCH - 9 * Math.Pow(10, basePoint - point);
            temp[1, 1] = CompensationADCH - 8 * Math.Pow(10, basePoint - point);
            temp[1, 2] = CompensationADCH - 7 * Math.Pow(10, basePoint - point);
            temp[1, 3] = CompensationADCH - 6 * Math.Pow(10, basePoint - point);
            temp[1, 4] = CompensationADCH - 5 * Math.Pow(10, basePoint - point);
            temp[1, 5] = CompensationADCH - 4 * Math.Pow(10, basePoint - point);
            temp[1, 6] = CompensationADCH - 3 * Math.Pow(10, basePoint - point);
            temp[1, 7] = CompensationADCH - 2 * Math.Pow(10, basePoint - point);
            temp[1, 8] = CompensationADCH - 1 * Math.Pow(10, basePoint - point);
            temp[1, 9] = CompensationADCH - 0 * Math.Pow(10, basePoint - point);
            temp[1, 10] = CompensationADCH + 1 * Math.Pow(10, basePoint - point);
            temp[1, 11] = CompensationADCH + 2 * Math.Pow(10, basePoint - point);
            temp[1, 12] = CompensationADCH + 3 * Math.Pow(10, basePoint - point);
            temp[1, 13] = CompensationADCH + 4 * Math.Pow(10, basePoint - point);
            temp[1, 14] = CompensationADCH + 5 * Math.Pow(10, basePoint - point);
            temp[1, 15] = CompensationADCH + 6 * Math.Pow(10, basePoint - point);
            temp[1, 16] = CompensationADCH + 7 * Math.Pow(10, basePoint - point);
            temp[1, 17] = CompensationADCH + 8 * Math.Pow(10, basePoint - point);
            temp[1, 18] = CompensationADCH + 9 * Math.Pow(10, basePoint - point);
