...
namespace TC_Insitu_Monitor.DAL
{
    public class DataSummarize
    {
        ...
        private const double coldTemp = 50;
        ...
        public DataSummarize(DataConfigsStatus dataConfigsStatus, DataConfigsStatus dataConfigsStatusTemperature, ConterEnum conterEnum, List<SaveFormalLogStruct> saveFormalLog, ConditionTC conditionTC, CorrespondentTemperature correspondentTemperature)
        {
            ...
            double layerH = dataConfigsStatus.DataFormatStruct.LayerH;
            double layerL = dataConfigsStatus.DataFormatStruct.LayerL;
            ...
            {
                Console.WriteLine($"id correspondentTemperature.Channel {id} {correspondentTemperature.Channel}");
            ...
            {
                Console.WriteLine("DWEL_L: 溫度低於標準電壓");
            ...
            {
                Console.WriteLine("DWEL_H: 溫度高於標準電壓");
            ...
            {
                Console.WriteLine($"RampUP && RampDown {mainTemperature} {conditionTC.LowTempThreshold + 0.1 * TempertureRange} {conditionTC.HighTempThreshold - 0.1 * TempertureRange}");
                //****************************************************
                //RampUP
                ...
                else if (status == "NA_H1")
                {
                    Console.WriteLine("RampDown");
                    status = "RampDown";
                    timeStampStart = timeTicks / 600000000;
                }
                //*************************************************************
