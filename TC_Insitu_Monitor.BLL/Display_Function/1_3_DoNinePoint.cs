...
{
    public class DoNinePoint: DoFormal
    {       
        public delegate void DisplayNinePoint(DataTable dataTable);
        public DisplayNinePoint displayNinePoint;

        protected DataConfigsPreTestDataTable dataConfigsPreTestDataTable = new DataConfigsPreTestDataTable();

        public void DoNinePointPrintData(Statuses statuses, ConditionTC conditionTCConfigs, string folderPath, string newPolderPath, ConterEnum conterEnum)
        {
            Task.Factory.StartNew(() => {
                if (statuses != null)
                {
                    ...
                    displayNinePoint(dataConfigsPreTestDataTable.Update(statuses.DataConfigsStatuses));
